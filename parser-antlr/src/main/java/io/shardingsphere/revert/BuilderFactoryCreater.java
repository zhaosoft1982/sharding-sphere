...
public class BuilderFactoryCreater {
    /**Get builder factory by database type.
     * 
     * @param dbType database type ex:mysql
     * @return sql builder factory
     */
    public static BuilderFactory getBuilderFactory(final int dbType) {
